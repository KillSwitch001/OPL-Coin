 ...
 *
 *   // network
 *   COplNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.opl.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COplNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: OplNetwork
// //   -- signature requirements : Key1(User)
// class COplNetworkVariable : public CGovernanceObject
// {
// private:
