    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OPL-light"), QVariant("light"));
    ui->theme->addItem(QString("OPL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("OPL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OPL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("OPL-traditional"), QVariant("trad"));
