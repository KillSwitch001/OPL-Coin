    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Opl Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Opl address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and opl: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Opl Core"), this);
    aboutAction->setStatusTip(tr("Show information about Opl Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Opl Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Opl addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Opl addresses"));
    ...
    openAction->setStatusTip(tr("Open a opl: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Opl Core help message to get a list with possible Opl Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Opl Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Opl network", "", count));
    } else {
...
{
    QString strTitle = tr("Opl Core"); // default title
