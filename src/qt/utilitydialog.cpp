    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Opl Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Opl Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  opl-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Opl in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OPL, 0.1 OPL, 1 OPL and 10 OPL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://oplpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://oplpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Opl Core is shutting down...") + "<br /><br />" +
