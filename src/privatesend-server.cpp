...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Opl related functionality
...
/*
    ...
    allow endless transaction that would bloat Opl and make it unusable. To
