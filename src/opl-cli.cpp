...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Opl Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  opl-cli [options] <command> [params]  " + _("Send command to Opl Core") + "\n" +
                  "  opl-cli [options] help                " + _("List commands") + "\n" +
                  "  opl-cli [options] help <command>      " + _("Get help for a command") + "\n";
