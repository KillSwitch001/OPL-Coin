...
This mechanism has been integrated into Bitcore-Node-Opl which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/oplbanana/insight-api-opl#web-socket-api](https://github.com/oplbanana/insight-api-opl#web-socket-api)
* API: [https://github.com/oplbanana/insight-api-opl#instantsend-transactions](https://github.com/oplbanana/insight-api-opl#instantsend-transactions)
...
By default, the Opl Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Opl Core daemon:
