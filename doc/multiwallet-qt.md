...
Only requiring some minor changes is opl.cpp.
...
Changes to opl.cpp
----------------------
opl.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
