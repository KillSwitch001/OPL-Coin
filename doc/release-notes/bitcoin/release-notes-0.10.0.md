...
- `98b135f` Make STRICTENC invalid pubkeys fail the script rather than the oplode
...
- `dfeec18` Test every numeric-accepting oplode for correct handling of the numeric minimal encoding rule
- `2b62e17` Clearly separate PUSHDATA and numeric argument MINIMALDATA tests
- `16d78bd` Add valid invert of invalid every numeric oplode tests
